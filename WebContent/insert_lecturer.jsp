...
<body>
	...
	<section>
		<h2>강사추가</h2>
		<form name="form" method="post" action="insert_lecturer_process.jsp">
			<table id="tab4" border=1>
			<tr>
				<th>강사 ID</th>
				<td><label><input id="in1" type="text" name="idx" value="<%=no %>">
				<span>자동증가(Sequence발생)</span></label></td>
			</tr>
			<tr>
				<th>강 사 명</th>
			...
			<tr>
				<th>연구분야</th>
				<td><input id="in2" type="text" name="field"></td>
			</tr>
			<tr>
